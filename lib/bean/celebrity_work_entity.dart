class CelebrityWorkEntity {
  ...
  CelebrityWorkEntity.fromJson(Map<String, dynamic> json) {
    celebrity = json['celebrity'] != null
        ? new CelebrityWorkCelebrity.fromJson(json['celebrity'])
        : null;
    total = json['total'];
    if (json['works'] != null) {
      works = new List<CelebrityWorkWork>();
      json['works'].forEach((v) {
        works.add(new CelebrityWorkWork.fromJson(v));
      });
    }
    count = json['count'];
    start = json['start'];
...
class CelebrityWorkCelebrity {
  ...
  CelebrityWorkCelebrity.fromJson(Map<String, dynamic> json) {
    ...
    avatars = json['avatars'] != null
        ? new CelebrityWorkCelebrityAvatars.fromJson(json['avatars'])
        : null;
    nameEn = json['name_en'];
  }
...
class CelebrityWorkWork {
  ...
  CelebrityWorkWork.fromJson(Map<String, dynamic> json) {
    subject = json['subject'] != null
        ? new CelebrityWorkWorksSubject.fromJson(json['subject'])
        : null;
...
class CelebrityWorkWorksSubject {
  ...
  CelebrityWorkWorksSubject.fromJson(Map<String, dynamic> json) {
    images = json['images'] != null
        ? new CelebrityWorkWorksSubjectImages.fromJson(json['images'])
        : null;
    ...
    if (json['directors'] != null) {
      ...
      json['directors'].forEach((v) {
        directors.add(new CelebrityWorkWorksSubjectDirector.fromJson(v));
      });
    }
    rating = json['rating'] != null
        ? new CelebrityWorkWorksSubjectRating.fromJson(json['rating'])
        : null;
    alt = json['alt'];
    title = json['title'];
    ...
    if (json['casts'] != null) {
      ...
      json['casts'].forEach((v) {
        casts.add(new CelebrityWorkWorksSubjectCast.fromJson(v));
      });
    }
...
class CelebrityWorkWorksSubjectDirector {
  ...
  CelebrityWorkWorksSubjectDirector(
      {this.name, this.alt, this.id, this.avatars, this.nameEn});
  ...
  CelebrityWorkWorksSubjectDirector.fromJson(Map<String, dynamic> json) {
    ...
    id = json['id'];
    avatars = json['avatars'] != null
        ? new CelebrityWorkWorksSubjectDirectorsAvatars.fromJson(
            json['avatars'])
        : null;
    nameEn = json['name_en'];
  }
...
class CelebrityWorkWorksSubjectDirectorsAvatars {
  ...
  CelebrityWorkWorksSubjectDirectorsAvatars(
      {this.small, this.large, this.medium});

  CelebrityWorkWorksSubjectDirectorsAvatars.fromJson(
...
class CelebrityWorkWorksSubjectRating {
  ...
  CelebrityWorkWorksSubjectRating(
  ...
  CelebrityWorkWorksSubjectRating.fromJson(Map<String, dynamic> json) {
    ...
    details = json['details'] != null
        ? new CelebrityWorkWorksSubjectRatingDetails.fromJson(json['details'])
        : null;
    stars = json['stars'];
  }
...
class CelebrityWorkWorksSubjectRatingDetails {
  ...
  CelebrityWorkWorksSubjectRatingDetails(
...
class CelebrityWorkWorksSubjectCast {
  ...
  CelebrityWorkWorksSubjectCast.fromJson(Map<String, dynamic> json) {
    ...
    id = json['id'];
    avatars = json['avatars'] != null
        ? new CelebrityWorkWorksSubjectCastsAvatars.fromJson(json['avatars'])
        : null;
    nameEn = json['name_en'];
  }
