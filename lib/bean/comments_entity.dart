  ...
  CommentsEntity.fromJson(Map<String, dynamic> json) {
    ...
    if (json['comments'] != null) {
      ...
      json['comments'].forEach((v) {
        comments.add(new CommantsBeanCommants.fromJson(v));
      });
    }
    nextStart = json['next_start'];
    subject = json['subject'] != null
        ? new CommentsBeanSubject.fromJson(json['subject'])
        : null;
    count = json['count'];
    start = json['start'];
  }
...
class CommantsBeanCommants {
  ...
  CommantsBeanCommants.fromJson(Map<String, dynamic> json) {
    ...
    author = json['author'] != null
        ? new CommentsBeanCommentsAuthor.fromJson(json['author'])
        : null;
    rating = json['rating'] != null
        ? new CommentsBeanCommentsRating.fromJson(json['rating'])
        : null;
...
class CommentsBeanSubject {
  ...
  CommentsBeanSubject.fromJson(Map<String, dynamic> json) {
    images = json['images'] != null
        ? new CommentsBeanSubjectImages.fromJson(json['images'])
        : null;
    ...
    if (json['directors'] != null) {
      ...
      json['directors'].forEach((v) {
        directors.add(new CommantsBeanSubjectDirectors.fromJson(v));
      });
    }
    rating = json['rating'] != null
        ? new CommentsBeanSubjectRating.fromJson(json['rating'])
        : null;
    alt = json['alt'];
    title = json['title'];
    ...
    if (json['casts'] != null) {
      ...
      json['casts'].forEach((v) {
        casts.add(new CommantsBeanSubjectCasts.fromJson(v));
      });
    }
...
class CommantsBeanSubjectDirectors {
  ...
  CommantsBeanSubjectDirectors.fromJson(Map<String, dynamic> json) {
    ...
    avatars = json['avatars'] != null
        ? new CommentsBeanSubjectDirectorsAvatars.fromJson(json['avatars'])
        : null;
    nameEn = json['name_en'];
  }
...
class CommentsBeanSubjectRating {
  ...
  CommentsBeanSubjectRating.fromJson(Map<String, dynamic> json) {
    ...
    details = json['details'] != null
        ? new CommentsBeanSubjectRatingDetails.fromJson(json['details'])
        : null;
    stars = json['stars'];
  }
...
class CommantsBeanSubjectCasts {
  ...
  CommantsBeanSubjectCasts.fromJson(Map<String, dynamic> json) {
    ...
    id = json['id'];
    avatars = json['avatars'] != null
        ? new CommentsBeanSubjectCastsAvatars.fromJson(json['avatars'])
        : null;
    nameEn = json['name_en'];
  }
